...
var define = typeof define === 'function' ? define : function(x) { window.Dumpling = x; };
...
define(Object.freeze(
  ...
  */
{ getMeta: function(prop, propAttr) {
...
, setMeta: function(prop, val, propAttr) {
    var attr = propAttr || 'property',
        meta = document.querySelector('meta[' + attr + '="' + prop + '"]');
    if (!meta) {
...
, getAncestor: function(node, test) {
    while(node) {
...
, forEachProp: function(obj, fn, scope) {
    for (var p in obj) {
...
, mapProps: function(obj, fn, scope) {
    var out = {};
    for (var p in obj) {
      if (obj.hasOwnProperty(p)) {
